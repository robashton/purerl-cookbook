...
Thankfully we can do *almost* all of this in Erlang (telling Erlang where to find the entry point is still writing Erlang, we don't make new applications very often at work so optimising for 'new projects' isn't something we've really focused on thus far).
