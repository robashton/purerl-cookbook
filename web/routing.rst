...
We don't need to worry about the inverse here, because Stetson has support for Routing Duplex built-in (in the future this might change as it's a hard dependency that isn't strictly necessary - we can't envisage not wanting typed routes however so this default sits comfortably with our teams).
